...
const FailedTask = ({data}) => {
  return (
    ...
    {data &&  <div className="flex-shrink-0  min-w-0 h-full w-[23%] bg-red-500  rounded-md px-2 py-2">
...
<div className="mt-5 ">
  ...
  <div className='flex  mt-5 '>
    <button className='bg-green-500 text-sm py-1 w-full rounded-lg px-2 '>Failed</button>
